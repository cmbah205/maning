  ...
  sock.ev.on("connection.update", (update) => {
    ...
    if (connection === "close") {
      ...
      if (reason === DisconnectReason.badSession) {
        console.log(
          "Bad Session File, Please Delete file session and Scan Again"
        );
        sock.logout();
      ...
      if (!messages[0].key.fromMe && !messages[0].key.participant) {
        ...
        if (!messages[0].key.fromMe && pesanMasuk === "tes") {
          ...
          let API_URL =
            ...
            pesanMasuk +
            "&lang=id&engine=g3&name=&pitch=0.5&rate=0.5&volume=1&key=kvfbSITh&gender=female";
          ...
          const templateButtons = [
            {
              ...
              urlButton: {
                ...
                url: "https://youtube.com/@cmbahtajab146",
              },
            },
            {
              index: 1,
          ...
          await sock.sendMessage(noWa, templateMessage, {
            quoted: messages[0],
          });
        } else if (
          !messages[0].key.fromMe &&
