        ...
        if(type === "notify"){
            if(!messages[0].key.fromMe && !messages[0].key.participant) {
                ...
                if(!messages[0].key.fromMe && pesanMasuk === "tes"){
                    ...
                    const buttons = [
                        {buttonId: "id1", buttonText: {displayText: 'Masuk'}, type: 1},
                        {buttonId: "id2", buttonText: {displayText: 'Tengah'}, type: 1},
                        {buttonId: "id3", buttonText: {displayText: 'Keluar'}, type: 1}
                    ]
                    const buttonInfo = {
                        text: "Info Pergerakan ",
                        buttons: buttons,
                        headerType: 1,
						viewOnce:true
                    }
                ...
                else if(!messages[0].key.fromMe && pesanMasuk === "suara") {

                    textsound = capital("Hidup ini adalah perjuangan yang besar");

                    let API_URL = "https://texttospeech.responsivevoice.org/v1/text:synthesize?text="+textsound+"&lang=id&engine=g3&name=&pitch=0.5&rate=0.5&volume=1&key=kvfbSITh&gender=female";
					...
					const templateButtons = [
						{index: 0, urlButton: {displayText: 'Lihat sample!', url: 'https://youtube.com/@cmbahtajab146'}},
						{index: 1, callButton: {displayText: 'Hotline CS', phoneNumber: '+6285643556205'}},
